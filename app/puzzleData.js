...
export const puzzles = [
  { 
    question: "Kuinka monta sormea sinulla on kädessä?", 
    answer: "5",
    correctFeedback: "Oikein! Loistava alku! Laita N 5 muistiin!",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "Mene kätkölle CGBDCYG. Mistä alkaen klo kätkö vaatii parkkikiekon?", 
    answer: "6",
    correctFeedback: "Rock Rakas! laita 6° talteen edellisen numeron perään.",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "10m kätköstä etelään löytyy numerosarja: 347X Mikä on X?", 
    answer: "5",
    correctFeedback: "Täydellistä! Tätä menoa isi tulee ja tekee temput sulle ❤️ Muistiin 5.",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "Kätkön lähettyviltä löytyy keltaisia autonlatausasemia, kuinka monta kappaletta?", 
    answer: "6",
    correctFeedback: "Erinomaista! Kohta mennään kyllä pusikkoon... vai kuusikkoon? Kuusi kuitenki muistiin 😘",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "Naateista N60° 7.720 E24° 41.088 löytyy numerosarja: 123633X. Mikä on X?", 
    answer: "7",
    correctFeedback: "Nice! Ja tästä saatiin mumero 7",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "Sitten suunataan kätkölle GCB5X33. Kätkölle on nopeusrajoitus 1Xkm/h. Kuinka paljon on X?", 
    answer: "0",
    correctFeedback: "Oikein! Nolla ei oo turha mutta ylös sekin.",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
    question: "Kätkön lähistöllä on kaappeja ja yhdessä niistä numerosarja J156X50. Taas etsitään X:ää.", 
    answer: "3",
    correctFeedback: "Täsmälleen! 3 ylös ja seikkailujatkuu (ehkä makkarin kautta?)",
    wrongFeedback: "Ei ihan. Yritä uudelleen tai saat suukon!"
  },
  { 
